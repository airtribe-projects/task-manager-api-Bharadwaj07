...
const getAllTasks = (completed = null, sortBy = 'id', sortOrder = 'asc') => {
...
const validatePayload = (payload) => {
    ...
    const hasPriority = payload.hasOwnProperty('priority');
    const isValidPriority = !hasPriority || validPriorities.includes(payload.priority);
    return (isValidTitle && isValidDescription && isValidCompletedFiled && isValidPriority);
}
